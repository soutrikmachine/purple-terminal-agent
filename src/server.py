...
logger.info("Executor model: %s", os.getenv("MODEL", "google/gemini-3.1-pro-preview"))
logger.info("Planner model:  %s", os.getenv("PLANNER_MODEL", os.getenv("MODEL", "google/gemini-3.1-pro-preview")))
