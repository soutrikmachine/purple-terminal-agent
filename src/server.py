...
logger.info("Executor model: %s", os.getenv("MODEL", "qwen/qwen3-coder-30b-a3b-instruct"))
logger.info("Planner model:  %s", os.getenv("PLANNER_MODEL", os.getenv("MODEL", "qwen/qwen3-coder-30b-a3b-instruct")))
