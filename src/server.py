...
logger.info("Executor model: %s", os.getenv("MODEL", "deepseek/deepseek-v4-pro"))
logger.info("Planner model:  %s", os.getenv("PLANNER_MODEL", os.getenv("MODEL", "deepseek/deepseek-v4-pro")))
